...
namespace MyFramework.Pages
{
    public class CalculatorPage
    {
        ...
        {
            var addNumberOfInstances = Webdriver.FindElement(By.Id("c11"));
            addNumberOfInstances.Clear();
            addNumberOfInstances.SendKeys("4");
        }
        public void EnterSeries()
        {
            // Click on Series and choose "N1"
            IWebElement Series = Webdriver.FindElement(By.CssSelector(".VfPpkd-TkwUic"));
            Series.Click();
            Series = Webdriver.FindElement(By.CssSelector("li[data-value='n1']"));
            Series.Click();
        }
        public void EnterMachineType()
        {
            // Click on "Machine type" anc choose Instance type: "n1-standard-8 (vCPUs: 8, RAM: 30 GB)"
            IWebElement Machinetype = Webdriver.FindElement(By.Id(".VfPpkd-ksKsZd-mWPk3d-OWXEXe-AHe6Kc-XpnDCe"));
            Machinetype.Click();
